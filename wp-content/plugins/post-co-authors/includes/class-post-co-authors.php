...
class Post_Co_Authors {
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Post_Co_Authors_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Post_Co_Authors_Public( $this->get_plugin_name(), $this->get_version() );
