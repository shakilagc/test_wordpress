	...
	<div class="single-entry-content">
		...
		<footer class="single-entry-meta">
			<p>
				...
				<?php printf( __( 'Categories: %2$s', 'tuned-balloon' ), 'entry-utility-prep entry-utility-prep-cat-links', get_the_category_list( ', ' ) ); ?> |
				<?php endif; ?>
				<?php $tags_list = get_the_tag_list( '', ', ' );
			if ( $tags_list ): ?>
				<?php printf( __( 'Tags: %2$s', 'tuned-balloon' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?> |
				<?php endif; ?>
		...
		<div class="author-info"> <?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'anariel_author_bio_avatar_size', 70 ) ); ?>
			<div class="author-description">
				<h3><?php printf( __( 'Author: %s', 'tuned-balloon' ), "<a href='" . get_author_posts_url( get_the_author_meta( 'ID' ) ) . "' title='" . esc_attr( get_the_author() ) . "' rel='me'>" . get_the_author() . "</a>" ); ?></h3>
				<p>
