				...
				<div class="row">
			  	...
			  	<div class="row">
			    	<div class="col-sm-12">
						...
						if($logo != ''){ ?>
						<div><img width="50px" height="50px" src="<?php echo $logo; ?>"></div>
			    		<?php } if($facebook_url != ''){ ?>
			    			<a href="<?php echo get_option('facebook_url'); ?>" target="blank"> Facebook </a>
			    		<?php } if($twitter_url != '') {?>
			    			<a href="<?php echo get_option('twitter_url'); ?>" target="blank"> Twitter </a>
			    		<?php } ?>
			      		<p class="credit <?php if ( has_nav_menu( 'social' ) ) { ?>credit-float<?php } ?>"><?php echo get_option('copyright');; ?></p>
