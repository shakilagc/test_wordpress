	...
	<?php 
		...
		<div class="entry-meta">
			...
			<?php if ( has_post_format( array('link') ) ) { ?>
				<?php echo $name ; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo lsx_get_my_url(); ?>" rel="bookmark"><?php the_title(); ?> <span class="genericon genericon-external"></span></a>
			<?php } else { ?>
				<?php echo $name ; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a>
			<?php } ?>
